 ...
 * @version 1.0.0
 */
public class LylacEntityHealthMutateEvent <T extends Entity> extends LylacEntityEvent {
    ...
    public LylacEntityHealthMutateEvent(Entity who, T by, int mutateValue, HealthMutateCause cause) {
        super(who, true);
        this.cause = cause;
